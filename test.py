...
def main():
    ...
    val_dataset = ImageToImage2D(dataset_path=opt.data_path, split=opt.test_split, joint_transform=tf_val,model=model, modelname=args.modelname, img_size=args.encoder_input_size, class_id=1,opt=opt)  # return image, mask, and filename
